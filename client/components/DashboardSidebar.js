...
function DashboardSidebar({wallpaper, tenants, roommates, rentStatus}) {
  ...
  return (
    <div className = "mt-4 col-md-4 pb-2 h-25" style = {{backgroundColor: "rgb(25,25,28)", borderRadius: "10px"}}>
        ...
        {state && state.user && state.user.landlord ? 
          ...
          (<>
            ...
            {roommates && roommates.map((roommate)=>{
              return(
                <div className = "px-3 py-2" style = {{borderTop: "1px solid rgba(70, 70, 70, 1)"}}>
