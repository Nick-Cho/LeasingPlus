let Account,hashPassword,comparePassword,jwt;_def‍.x([["register",()=>register],["login",()=>login],["forgotPassword",()=>forgotPassword]]);_def‍.w("../models/user",[["default",["Account"],function(v){Account=v}]]);_def‍.w("../helpers/auth",[["hashPassword",["hashPassword"],function(v){hashPassword=v}],["comparePassword",["comparePassword"],function(v){comparePassword=v}]]);_def‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);
  ...
  try{ 
    ...
    _def‍.g.console.log("Register endpoint error: ", err);
  ...
  try{
    ...
    _def‍.g.console.log("Error in login endpoint ", err);
  ...
  try{
    ...
    _def‍.g.console.log(secretQuestion, secret)
