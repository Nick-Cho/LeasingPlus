let UserContext,Account;_aa3‍.x([["inviteUser",()=>inviteUser],["getInvite",()=>getInvite],["denyInvite",()=>denyInvite]]);_aa3‍.w("../../client/context",[["UserContext",["UserContext"],function(v){UserContext=v}]]);_aa3‍.w("../models/user",[["default",["Account"],function(v){Account=v}]]);
...
const mongoose = require("mongoose");
  ...
  try{
    ...
    _aa3‍.g.console.log(err);
       ...
       async function denyInvite(req,res){
  try{
    ...
    let new_user = await UserContext.findByIdAndUpdate(user._id, user, {new:true});
