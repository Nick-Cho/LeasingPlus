let Account,cloudinary;_7da‍.x([["searchUser",()=>searchUser],["uploadImage",()=>uploadImage],["getUser",()=>getUser],["inviteUser",()=>inviteUser],["getInvite",()=>getInvite]]);_7da‍.w("../models/user",[["default",["Account"],function(v){Account=v}]]);_7da‍.w("cloudinary",[["default",["cloudinary"],function(v){cloudinary=v}]]);
...
cloudinary.config({
  ...
  try{
    ...
    _7da‍.g.console.log("uploaded image url: ", result );
  ...
  _7da‍.g.console.log(req.body)
  const {user_id} = req.body.user_id;
  try{
    const user = await Account.findOne({_id: req.params.id}).select('-password -secret -secretQuestion -roommates -rentCollected -rentPaid -rent')
    _7da‍.g.console.log(user)
  } catch (err) {
    _7da‍.g.console.log(err);
  }
}