let Account,hashPassword,comparePassword,jwt;_c14‍.x([["register",()=>register],["login",()=>login],["forgotPassword",()=>forgotPassword]]);_c14‍.w("../models/user",[["default",["Account"],function(v){Account=v}]]);_c14‍.w("../helpers/auth",[["hashPassword",["hashPassword"],function(v){hashPassword=v}],["comparePassword",["comparePassword"],function(v){comparePassword=v}]]);_c14‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);
  ...
  try{ 
    ...
    _c14‍.g.console.log("Register endpoint error: ", err);
  ...
  try{
    ...
    _c14‍.g.console.log("Error in login endpoint ", err);
  ...
  try{
    ...
    _c14‍.g.console.log(secretQuestion, secret)
