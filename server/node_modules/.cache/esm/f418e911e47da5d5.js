let Account,hashPassword,comparePassword,jwt,UserContext;_e47‍.x([["register",()=>register],["login",()=>login],["forgotPassword",()=>forgotPassword]]);_e47‍.w("../models/user",[["default",["Account"],function(v){Account=v}]]);_e47‍.w("../helpers/auth",[["hashPassword",["hashPassword"],function(v){hashPassword=v}],["comparePassword",["comparePassword"],function(v){comparePassword=v}]]);_e47‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);_e47‍.w("../../client/context",[["UserContext",["UserContext"],function(v){UserContext=v}]]);
  ...
  try{ 
    ...
    _e47‍.g.console.log("Register endpoint error: ", err);
  ...
  try{
    ...
    _e47‍.g.console.log("Error in login endpoint ", err);
